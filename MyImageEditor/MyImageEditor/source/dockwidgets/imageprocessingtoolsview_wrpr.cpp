...
void CImageProcessingToolsViewWrpr::setWidget(QWidget* f_widget)
{
    ...
    connect(m_imageProcessingToolsView_ui.m_convertToMono_chkBx, SIGNAL(stateChanged(int)), this, SLOT(doReloadImage()));
    connect(m_imageProcessingToolsView_ui.m_detectEdges_chkBx, SIGNAL(stateChanged(int)), this, SLOT(doReloadImage()));
...
void CImageProcessingToolsViewWrpr::doReloadImage()
{
    ...
    l_imageEditParams.m_convertToMonochrome_b = m_imageProcessingToolsView_ui.m_convertToMono_chkBx->isChecked();
    l_imageEditParams.m_detectEdges_b = m_imageProcessingToolsView_ui.m_detectEdges_chkBx->isChecked();
